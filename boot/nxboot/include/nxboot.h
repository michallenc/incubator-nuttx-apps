...
enum nxboot_img_flags
{
  NXBOOT_IMAGE_FLAG_UKNOWN = 0,   /* Unknown state */
  NXBOOT_IMAGE_FLAG_UNSET = 1,    /* Flag not set -> image not confirmed */
  NXBOOT_IMAGE_FLAG_CONFIRM = 2,  /* Flag set -> image confirmed */
  NXBOOT_IMAGE_FLAG_UPDATED = 3,  /* Flag set -> image was updated */
  NXBOOT_IMAGE_FLAG_AVAIL = 4,    /* Flag set -> partition available */
};
...
struct nxboot_img_version
{
  ...
  char pre_release[44];  /* Additional pre-release version */
};
